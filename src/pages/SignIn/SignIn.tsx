...
export const SignIn = () => {
  ...
  return (
    <section className="h-screen">
      <div className="flex px-6 py-12 h-full flex-col justify-center items-center">
        <div className="flex w-8/12 flex-col justify-center items-center flex-wrap g-6 text-gray-800 bg-indigo-500 h-auto py-4 rounded-2xl">
